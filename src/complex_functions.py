...
class ComplexTensor:
        ...
        if 'tuple' in x.__class__.__name__:
            if len(x) == 2:
                if 'ndarray' in x[0].__class__.__name__:
                    ...
                    raise TypeError(
                        "Only torch.tensor or np.array can be converted to a ComplexTensor.")
            ...
            warnings.warn(
                "Warning: You are trying to convert an already ComplexTensor to a ComplexTensor.")
            self.z = x.z
            ...
            if complex is True:
                if x.size()[-1] == 2:
                    ...
                    raise RuntimeError('For a Tensor to become complex, the last dimension should be of size 2 and not ' + str(
    ...
    def __repr__(self):
        ...
        strings = np.asarray([complex(a, b) for a, b in zip(real, imag)]
                             ).astype(np.complex64).reshape(*self.size())
    ...
    def __add__(self, other):
        if "ComplexTensor" in other.__class__.__name__:
            ...
            raise TypeError("ComplexTensor and " +
    ...
    def __rsub__(self, other):
        if "ComplexTensor" in other.__class__.__name__:
            ...
            raise TypeError("Cannot subtract a ComplexTensor from " +
                            str(other.__class__.__name__) + ".")
        return result
    ...
    def __truediv__(self, other):
        if "ComplexTensor" in other.__class__.__name__:
            ...
            result = ComplexTensor((real, imag), complex=True,
                                   requires_grad=self.requires_grad_check(other))
        elif "Tensor" in other.__class__.__name__:
    ...
    def __matmul__(self, other):
        if "ComplexTensor" in other.__class__.__name__:
            ...
            raise TypeError("ComplexTensor cannot matrix - multiply " +
                            str(other.__class__.__name__))
        return result
