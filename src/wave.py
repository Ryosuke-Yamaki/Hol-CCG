...
wave_list['{}_{}'.format(w0, w1)] = single_circular_correlation(wave_list[w0], wave_list[w1])
wave_list['{}_{}'.format(w2, w3)] = single_circular_correlation(wave_list[w2], wave_list[w3])
