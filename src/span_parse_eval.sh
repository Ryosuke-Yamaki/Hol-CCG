...
cd ~/Hol-CCG/src
python transform_data_for_eval.py ~/span_parsing/CCGBANK_DEPS/${result}.ccgbank_deps ~/span_parsing/AUTO/${result}.auto

cd ~/java-candc
python2 scripts/evaluate_new ~/span_parsing/GOLD/${gold}.stagged ~/span_parsing/GOLD/${gold}.ccgbank_deps ~/span_parsing/CCGBANK_DEPS/${result}.ccgbank_deps|tee ~/span_parsing/EVAL/${result}.eval 